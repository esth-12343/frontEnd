...
const TeacherRegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage(t('register.successTeacher'));
  ...
  return (
    <div className="register-container">
      ...
      <div className="register-card glass-panel">
        ...
        <h1 className="register-title">{t('register.titleTeacher')}</h1>
        <p className="register-subtitle">{t('register.subtitleTeacher')}</p>
        ...
        <form onSubmit={handleSubmit} className="register-form">
          ...
          <div className="input-group">
            ...
            <input
              ...
              onChange={handleChange}
              className="form-control"
              placeholder={t('register.emailPlaceholderTeacher')}
              required
            />
          </div>
          ...
          <button type="submit" className="btn-primary" disabled={isLoading}>
            {!isLoading ? <span>{t('register.registerButtonTeacher')}</span> : <span className="spinner"></span>}
          </button>
        </form>
